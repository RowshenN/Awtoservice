...
const ServiceCard = ({ image, icon, header, desc }) => {
  return (
    <div data-aos="fade-up" className="w-full shadow-lg bg-white rounded-lg pb-[26px] ">
      <div className="w-full z-10 h-[210px]">
        <img
          src={image}
          alt="image"
      ...
      <div className="w-full mt-[-50px] px-10">
        <div className="py-[17px] z-20 px-[18px] mb-[22px] bg-[#5996C5] rounded-lg w-[80px] h-[80px] ">
          <img
            src={icon}
            alt="icon"
            className="w-[45px] z-20 h-[45px] object-cover "
          />
        </div>
